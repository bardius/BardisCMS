...
sudo -t -H -u $4 bash -c "sudo chmod 0755 -R $3/web/uploads"

echo -e "\n\n\e[0;34m********** Set permissions to cache folder **********\e[0m"
echo sudo -t -H -u $4 bash -c "sudo chmod 0755 -R $3/app/cache"
sudo -t -H -u $4 bash -c "sudo chmod 0755 -R $3/app/cache"

echo -e "\n\n\e[0;34m********** Set permissions to logs folder **********\e[0m"
echo sudo -t -H -u $4 bash -c "sudo chmod 0755 -R $3/app/logs"
sudo -t -H -u $4 bash -c "sudo chmod 0755 -R $3/app/logs"
