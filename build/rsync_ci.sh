...
echo sudo -t -H -u $4 bash -c "sudo mv -v $dirRoot/$2/composer.json.jenkins $dirRoot/$2/composer.json"
sudo -t -H -u $4 bash -c "sudo mv -v $dirRoot/$2/composer.json.jenkins $dirRoot/$2/composer.json"

echo -e "\n\n\e[0;34m********** Updating Composer Dependensies **********\e[0m"
echo sudo -t -H -u $4 bash -c "sudo php $dirRoot/$2/composer.phar install -o"
sudo -t -H -u $4 bash -c "sudo php $dirRoot/$2/composer.phar install -o"
